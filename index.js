...
const userCollection = client.db("food-station").collection("users");
    const menuCollection = client.db("food-station").collection("menu");
    const reviewCollection = client.db("food-station").collection("reviews");
    const cartCollection = client.db("food-station").collection("carts");
    const paymentCollection = client.db("food-station").collection("payments");
    ...
    app.post('/payments', async (req, res) => {
      ...
      // console.log('payment info', payment);
      // const query = {_id: {
      //     $in: payment.cartIds.map(id => ObjectId.createFromTime(id))
      //   }};
      const query = {_id: {
...
app.listen(port, () => {
  console.log(`food is coming on port ${port}`);
});
// 